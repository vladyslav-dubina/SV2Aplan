...
class PowTranslator(BaseTranslator):
    ...
    def translate(
        ...
        pow_init_action, pow_init_protocol = self.createAction(0, protocol_params)

        pow_cond_action, pow_main_protocol = self.createAction(3, protocol_params)
