...
from Core.src.classes.declarations import DeclTypes
...
class FloorTranslator(BaseTranslator):
    ...
    def translate(
        ...
        # DECLARE VARS
        self._translator_ptr.getTranslator("typedef").create(
            "floor_struct",
        ...
        result_floor = self._translator_ptr.translate(
            "declaration",
            "floor_obj",
            DeclTypes.STRUCT,
        ...
        action_floor_check = self.createAction(0, protocol_params)
        action_floor_body_gtz = self.createAction(1, protocol_params)
        action_floor_body_ltz = self.createAction(2, protocol_params)
        action_floor_check_fp = self.createAction(3, protocol_params)
        action_floor_body_fp = self.createAction(4, protocol_params)
        action_floor_result = self.createAction(5, protocol_params)
