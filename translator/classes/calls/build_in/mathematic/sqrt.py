...
class SqrtTranslator(BaseTranslator):
    ...
    def translate(
        ...
        result_sqrt = self._translator_ptr.translate(
            "declaration",
            "sqrt_obj",
            DeclTypes.STRUCT,
        ...
        sqrt_structure = Structure(
            beh_protocol_name, (0, 0), ElementsTypes.TASK_ELEMENT
        )
        ...
        sqrt_init_action, sqrt_init_protocol = self.createAction(0, protocol_params)
        sqrt_body_action, sqrt_body_protocol = self.createAction(1, protocol_params)
    ...
    def createStart(self, protocol_params: ParametrArray = ParametrArray()):
