...
def generateBodyToAplan(
    self: Module_Translator, ctx, sv_structure: Structure, init_var_name, current_value
):
...
def generate2AplanImpl(
    self: Module_Translator, ctx: SystemVerilogParser.Loop_generate_constructContext
):
    generate_name = (
